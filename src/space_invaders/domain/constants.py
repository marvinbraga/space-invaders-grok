...
# Bullets
PLAYER_BULLET_SPEED: Final[float] = 155.0
ALIEN_BULLET_SPEED: Final[float] = 120.0
...
UFO_Y: Final[int] = 24
UFO_SPEED: Final[float] = 58.0
UFO_SPAWN_MIN: Final[float] = 6.0
UFO_SPAWN_MAX: Final[float] = 14.0
...
BASE_STEP_INTERVAL: Final[float] = 0.30
MIN_STEP_INTERVAL: Final[float] = 0.022
DROP_DISTANCE: Final[int] = 11
EDGE_MARGIN: Final[int] = 8
INVASION_Y: Final[int] = PLAYER_Y - 8
FORMATION_STEP_PIXELS: Final[float] = 2.75

# Alien fire
BASE_ALIEN_FIRE_INTERVAL: Final[float] = 0.55
MIN_ALIEN_FIRE_INTERVAL: Final[float] = 0.14
